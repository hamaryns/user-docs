# -*- coding: utf-8 -*-
#
# Foodsoft documentation build configuration file, created by
...
project = u'Foodsoft'
copyright = u'2017, Foodsoft developers'
author = u'Foodsoft developers'
...
latex_documents = [
    (master_doc, 'Foodsoft.tex', u'Foodsoft Documentation',
     u'Foodsoft developers', 'manual'),
]
...
man_pages = [
    (master_doc, 'foodsoft', u'Foodsoft Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Foodsoft', u'Foodsoft Documentation',
     author, 'Foodsoft', 'One line description of project.',
     'Miscellaneous'),
]
